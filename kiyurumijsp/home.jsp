...
<div id="contents">
 ...
 <a class="h_imgimg">素敵なイベントを一緒に盛り上げるんだモン！<br>日本地図をチェッくま〜☆</a>
 	...
 	<div id="nihon" style="zoom: 1.4;">
  		   <ul id="imagemap">
			<li id="hokkaidotouhoku"><a href='<s:url action="SearchItemAction"><s:param name="categoryId" value="2"/></s:url>'><span>北海道_東北</span></a><div class="hukidashi"><p class="moji">北海道と東北ジン<br></p><p class="image"><img src="./images/jin.png" /></p></div></li>
